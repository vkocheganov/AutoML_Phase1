...
train_data = select_clf.transform(train_data,threshold=0.02)
valid_data = select_clf.transform(valid_data,threshold=0.02)
test_data = select_clf.transform(test_data,threshold=0.02)
...
gbt_params=GBT_params(n_iterations=20000,depth=11, learning_rate=0.01,subsample_part=0.6,n_max_features=gbt_features,min_samples_split=6, min_samples_leaf=3)
